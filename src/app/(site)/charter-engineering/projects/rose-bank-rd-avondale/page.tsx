...
export default function RoseBankRdPage() {
  ...
  return (
    <>
      <PageTitle
        pageTitle="Rose Bank Rd"
        pageDescription="Land subdivision project in Avondale, Auckland"
        breadcrumbTitle="Chartered Engineering / Rose Bank Rd"
      />
          ...
          <div className="grid grid-cols-1 gap-4 lg:gap-8 lg:grid-cols-2">
            ...
            <div className="order-2 lg:order-1 flex flex-col space-y-6 pt-4 lg:pt-0">
              ...
              <p className="text-base leading-relaxed text-body-color">
                Located at Rose Bank Rd in Avondale, Auckland, this comprehensive land subdivision project 
                showcases our expertise in chartered civil engineering. The project involved transforming 
                a single residential lot into five separate properties, requiring detailed surveying, 
                ...
                <div className="rounded-lg bg-gray-50 p-4">
                  ...
                  <ul className="space-y-2 text-sm text-body-color">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Location: Rose Bank Rd, Avondale, Auckland</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <svg className="h-5 w-5 flex-shrink-0 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    ...
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Scale: 1 lot subdivided into 5 lots</span>
                    </li>
                  </ul>
                </div>
                <div className="rounded-lg bg-gray-50 p-4">
                  ...
                  <ul className="space-y-2 text-sm text-body-color">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Comprehensive land assessment and planning</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <svg className="h-5 w-5 flex-shrink-0 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                      </svg>
                      <span>Complex infrastructure development</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <svg className="h-5 w-5 flex-shrink-0 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
              ...
              <div className="mt-4">
                ...
                <p className="text-base leading-relaxed text-body-color">
                  This project presented significant engineering challenges due to the scale of subdivision from one 
                  lot into five separate properties. Our team implemented innovative engineering solutions to address 
                  stormwater management, utilities distribution, and access requirements for all five lots while ensuring 
              ...
              <div className="mt-4">
                ...
                <ul className="mt-3 space-y-2 text-base text-body-color">
                  <li className="flex items-start space-x-3">
                    ...
                    <span>Complex boundary planning and survey coordination</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <svg className="h-6 w-6 flex-shrink-0 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span>Advanced stormwater management system design</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <svg className="h-6 w-6 flex-shrink-0 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span>Multi-property utility services planning and installation</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <svg className="h-6 w-6 flex-shrink-0 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span>Comprehensive resource consent documentation and management</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-lg bg-white p-8 shadow-lg">
                ...
                <p className="text-body-color">
                  ...
                  to determine optimal subdivision design for five separate lots while identifying potential challenges.
                </p>
              </div>
              <div className="rounded-lg bg-white p-8 shadow-lg">
                <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 text-primary">
                ...
                <p className="text-body-color">
                  Advanced engineering design of lot boundaries, access points, and utility connections to ensure 
                  all five properties meet council requirements while maximizing land utilization.
                </p>
              </div>
              <div className="rounded-lg bg-white p-8 shadow-lg">
                <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 text-primary">
                ...
                <p className="text-body-color">
                  ...
                  documentation met Auckland Council requirements for efficient approval of a five-lot subdivision.
                </p>
              </div>
              <div className="rounded-lg bg-white p-8 shadow-lg">
                <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 text-primary">
                ...
                <p className="text-body-color">
                  Implementation of extensive infrastructure modifications, including comprehensive stormwater management systems, 
                  utility connections, and access solutions for all five properties.
                </p>
              </div>
              <div className="rounded-lg bg-white p-8 shadow-lg">
                <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 text-primary">
              ...
              <div className="rounded-lg bg-white p-8 shadow-lg">
                ...
                <p className="text-body-color">
                  Rigorous quality control throughout this major subdivision project, ensuring all engineering aspects met 
                  the highest standards and complied with regulatory requirements for a 1-to-5 lot development.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 rounded-lg bg-gray-50 p-8 lg:p-12">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mb-6 font-medium italic text-body-color">
                &quot;Charter Engineering&apos;s management of our Rose Bank Rd subdivision was exceptional. The complexity of converting one lot into 
                five separate properties required significant engineering expertise, which they delivered with professionalism and precision. 
                Their innovative solutions to our specific site challenges resulted in an optimal development outcome.&quot;
              </p>
              <div>
                <h4 className="font-semibold text-dark">Property Developer</h4>
                <p className="text-sm text-body-color">Rose Bank Rd, Avondale</p>
              </div>
            </div>
          </div>
