...
export default function LewisStBlockhouseBayPage() {
  ...
  return (
    <>
      <PageTitle
        pageTitle="Lewis St., Blockhouse Bay"
        pageDescription="Land subdivision project in Blockhouse Bay, Auckland"
        breadcrumbTitle="Chartered Engineering / Lewis St., Blockhouse Bay"
      />
          ...
          <div className="grid grid-cols-1 gap-4 lg:gap-8 lg:grid-cols-2">
            ...
            <div className="order-2 lg:order-1 flex flex-col space-y-6 pt-4 lg:pt-0">
              ...
              <p className="text-base leading-relaxed text-body-color">
                Located at Lewis Street in Blockhouse Bay, Auckland, this precision land subdivision project 
                ...
                <div className="rounded-lg bg-gray-50 p-4">
                  ...
                  <ul className="space-y-2 text-sm text-body-color">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Location: Lewis St., Blockhouse Bay, Auckland</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <svg className="h-5 w-5 flex-shrink-0 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                ...
                <div className="rounded-lg bg-gray-50 p-4">
                  ...
                  <ul className="space-y-2 text-sm text-body-color">
                    ...
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Complex infrastructure design</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <svg className="h-5 w-5 flex-shrink-0 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
              ...
              <div className="mt-4">
                ...
                <p className="text-base leading-relaxed text-body-color">
                  This complex project required sophisticated solutions for stormwater management, 
                  utility connections, and access considerations for all four lots. Our team implemented innovative 
                  engineering approaches to maximize land utilization while ensuring each property met all 
              ...
              <div className="mt-4">
                ...
                <ul className="mt-3 space-y-2 text-base text-body-color">
                  <li className="flex items-start space-x-3">
                    ...
                    <span>Complex boundary definition and survey coordination</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <svg className="h-6 w-6 flex-shrink-0 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  ...
                  <li className="flex items-start space-x-3">
                    ...
                    <span>Extensive utility services planning and connections</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <svg className="h-6 w-6 flex-shrink-0 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-lg bg-white p-8 shadow-lg">
                ...
                <p className="text-body-color">
                  In-depth evaluation of the site&apos;s topography, soil conditions, and existing infrastructure 
                  to determine optimal subdivision design for four lots and identify potential challenges.
                </p>
              </div>
              <div className="rounded-lg bg-white p-8 shadow-lg">
                <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 text-primary">
                ...
                <p className="text-body-color">
                  Advanced engineering design of lot boundaries, access solutions, and utility connections to ensure 
                  all four properties meet council requirements with optimal land utilization.
                </p>
              </div>
              <div className="rounded-lg bg-white p-8 shadow-lg">
                <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 text-primary">
                ...
                <p className="text-body-color">
                  Meticulous preparation and management of resource consent applications for a complex subdivision, 
                  ensuring all technical documentation met Auckland Council requirements for efficient approval.
                </p>
              </div>
              <div className="rounded-lg bg-white p-8 shadow-lg">
                <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 text-primary">
                ...
                <p className="text-body-color">
                  Implementation of complex infrastructure modifications, including sophisticated stormwater management systems, 
                  multiple utility connections, and optimized access solutions for all four properties.
                </p>
              </div>
              <div className="rounded-lg bg-white p-8 shadow-lg">
                <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 text-primary">
                ...
                <p className="text-body-color">
                  ...
                  to ensure smooth progression of this complex subdivision project.
                </p>
              </div>
              <div className="rounded-lg bg-white p-8 shadow-lg">
                <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 text-primary">
                ...
                <p className="text-body-color">
                  Rigorous quality control throughout this multi-lot project, ensuring all engineering aspects met 
                  the highest standards and complied with complex regulatory requirements.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 rounded-lg bg-gray-50 p-8 lg:p-12">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mb-6 font-medium italic text-body-color">
                &quot;We were impressed by the engineering team&apos;s innovative approach to our complex subdivision in Blockhouse Bay. 
                Their technical expertise and attention to detail made it possible to maximize our property&apos;s potential, creating 
                four quality lots where we originally thought only two or three might be possible.&quot;
              </p>
              <div>
                <h4 className="font-semibold text-dark">Property Developer</h4>
                <p className="text-sm text-body-color">Lewis Street, Blockhouse Bay</p>
              </div>
            </div>
          </div>
