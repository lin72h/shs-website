...
export default function PinecrestDrPage() {
  ...
  // For Google Maps - Auckland coordinates with slight offset to represent Pinecrest Dr
          ...
          <div className="grid grid-cols-1 gap-4 lg:gap-8 lg:grid-cols-2">
            ...
            <div className="order-1 lg:order-2 grid gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                {/* Google Maps replacing the second thumbnail */}
                <div 
                    ...
                    markers={[
                      {
                        ...
                        title: "347 Pinecrest Dr, Auckland"
                      }
                    ]}
                  />
                  <div className="absolute bottom-2 right-2 rounded-full bg-white p-1.5 z-10">
                ...
                >
                  <Image
                    src={pinecrestImages[3].src}
                    alt={pinecrestImages[3].alt}
                    fill
                    className="object-cover"
                  />
                  <div className="absolute inset-0 bg-black bg-opacity-0 transition-opacity hover:bg-opacity-10">
                ...
                >
                  <Image
                    src={pinecrestImages[4].src}
                    alt={pinecrestImages[4].alt}
                    fill
                    className="object-cover"
                  />
                  <div className="absolute inset-0 bg-black bg-opacity-0 transition-opacity hover:bg-opacity-10">
