  ...
  return (
    <div className="w-full px-4 md:w-1/2 xl:w-1/4">
      <div className="mx-auto mb-10 w-full max-w-[370px]">
        <div 
          className="relative aspect-[149/182] overflow-hidden rounded-lg shadow-md"
          style={{
            background: `linear-gradient(to bottom right, ${team.gradient.from}, ${team.gradient.to})`
          }}
        >
          <div className="absolute bottom-5 left-0 w-full text-center">
            <div className="relative mx-5 overflow-hidden rounded-lg bg-white px-3 py-5 shadow-lg">
